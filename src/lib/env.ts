...
export const envSchema = z.object({
  ...
  USERAVAA_STAGING_ACCESS_HEADER: z.string().optional(),
  USERAVAA_STAGING_ACCESS_IDENTITY_HEADER: z.string().optional(),
  USERAVAA_STAGING_ACCESS_SECRET: z.string().optional(),
